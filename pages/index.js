...
export default function Home() {
  ...
  <div className='w-[100%]'>
    ...
    <div className='w-[100%] py-[10px] px-[20px] flex justify-between items-center  shadow-under'> 
        ...
        <div className='flex justify-between items-center w-[70px] mr-[20px]'>
          <a href=''>
      ...
      <div className='w-[70%]  '>
        <div className='mark h-[280px] m-[20px] p-[20px] rounded-[10px] '> 
          ...
          <div className='h-[85%] flex justify-center items-center'>
              <form className='w-[100%] my-auto flex flex-col justify-between items-center  h-[80%] '> 
                ...
                <button className='w-[90%] border-[2px] rounded-[5px] p-[10px] bg-cyan-200 text-[1rem] font-medium'>Share</button>
              </form>
